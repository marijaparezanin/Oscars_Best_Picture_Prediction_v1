...
def normality_of_errors_assumption(model, features, label, p_value_thresh=0.02, plot=True):
    '''
...
def are_assumptions_satisfied(model, features, labels, p_value_thresh=0.05):
    ...
    '''print("********************************")
    print(is_linearity_found)
    print(autocorrelation is None)
    print(n_dist_type == 'normal')
    print(e_dist_type)'''
